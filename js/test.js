...
var key = "fqns0dx3gcmt4as525w5cyd6a";
...
iframe.setAttribute(
  "src",
  "https://my.matterport.com/show/?m=3PY8GTH7oyP&hhl=0&play=1&tiles=1&hl=0"
);
...
function sweepToMap(p) {
  ...
  if (p) {
    ...
    var x = scaleToContainer(p.x, minX, maxX, 29, 3);
    var y = scaleToContainer(p.y, minY, maxY, 50, 20);
